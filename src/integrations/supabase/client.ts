...
function createSupabaseClient() {
  ...
  pushDebugEvent('client.ts', 'createSupabaseClient', 'createSupabaseClient()', {
    clientId: _clientId,
    isInBrowser,
    storageMode: isInBrowser ? 'localStorage' : '⚠️ memory-only — session will not persist',
  }, isInBrowser ? 'info' : 'warn');
